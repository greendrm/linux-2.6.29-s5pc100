...
#define S3C2440_UFCON_RXTRIG0	  (0<<4)
#define S3C2440_UFCON_RXTRIG4	  (1<<4)
#define S3C2440_UFCON_RXTRIG8	  (2<<4)
#define S3C2440_UFCON_RXTRIG16	  (3<<4)
#define S3C2440_UFCON_RXTRIG32	  (4<<4)
#define S3C2440_UFCON_RXTRIG64	  (5<<4)
#define S3C2440_UFCON_RXTRIG128	  (6<<4)
#define S3C2440_UFCON_RXTRIG256	  (7<<4)

#define S3C2440_UFCON_TXTRIG0	  (0<<8)
#define S3C2440_UFCON_TXTRIG4	  (1<<8)
#define S3C2440_UFCON_TXTRIG8	  (2<<8)
#define S3C2440_UFCON_TXTRIG16	  (3<<8)
#define S3C2440_UFCON_TXTRIG32	  (4<<8)
#define S3C2440_UFCON_TXTRIG64	  (5<<8)
#define S3C2440_UFCON_TXTRIG128	  (6<<8)
#define S3C2440_UFCON_TXTRIG256	  (7<<8)
...
#define S3C64XX_UFCON_DEFAULT	(S3C2410_UFCON_FIFOMODE | \
					S3C2440_UFCON_TXTRIG4  | \
					S3C2440_UFCON_RXTRIG4 )
#else
#define S3C64XX_UFCON_DEFAULT	(S3C2410_UFCON_FIFOMODE | \
