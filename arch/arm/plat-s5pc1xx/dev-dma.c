...
struct s3c_pl330_platdata s5pc1xx_mdma_pdata = {
	.peri = {
...
struct s3c_pl330_platdata s5pc1xx_pdma1_pdata = {
	.peri = {
		[0] = DMACH_UART0_RX,
		[1] = DMACH_UART0_TX,
		[2] = DMACH_UART1_RX,
...
struct s3c_pl330_platdata s5pc1xx_pdma0_pdata = {
	.peri = {
		[0] = DMACH_UART0_RX,
		[1] = DMACH_UART0_TX,
		[2] = DMACH_UART1_RX,
...
EXPORT_SYMBOL(s5pc1xx_device_mdma);
...
EXPORT_SYMBOL(s5pc1xx_device_pdma0);
...
EXPORT_SYMBOL(s5pc1xx_device_pdma1);
