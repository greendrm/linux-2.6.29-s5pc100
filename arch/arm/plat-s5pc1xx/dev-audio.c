...
{
	s3c_gpio_cfgpin(S5PC1XX_GPC(0), S5PC1XX_GPC0_AC97_BITCLK);
	s3c_gpio_cfgpin(S5PC1XX_GPC(1), S5PC1XX_GPC1_AC97_RESETn);
	s3c_gpio_cfgpin(S5PC1XX_GPC(2), S5PC1XX_GPC2_AC97_SYNC);
	s3c_gpio_cfgpin(S5PC1XX_GPC(3), S5PC1XX_GPC3_AC97_SDI);
	s3c_gpio_cfgpin(S5PC1XX_GPC(4), S5PC1XX_GPC4_AC97_SDO);
