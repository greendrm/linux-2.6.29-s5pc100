...
{
	switch (group) {
	case 0: return S5PC1XX_GPIO_A0_START;
	case 1: return S5PC1XX_GPIO_A1_START;
	case 2: return S5PC1XX_GPIO_B_START;
	case 3: return S5PC1XX_GPIO_C_START;
	case 4: return S5PC1XX_GPIO_D_START;
	case 5: return S5PC1XX_GPIO_E0_START;
	case 6: return S5PC1XX_GPIO_E1_START;
	case 7: return S5PC1XX_GPIO_F0_START;
	case 8: return S5PC1XX_GPIO_F1_START;
	case 9: return S5PC1XX_GPIO_F2_START;
	case 10: return S5PC1XX_GPIO_F3_START;
	case 11: return S5PC1XX_GPIO_G0_START;
	case 12: return S5PC1XX_GPIO_G1_START;
	case 13: return S5PC1XX_GPIO_G2_START;
	case 14: return S5PC1XX_GPIO_G3_START;
	case 15: return S5PC1XX_GPIO_I_START;
	case 16: return S5PC1XX_GPIO_J0_START;
	case 17: return S5PC1XX_GPIO_J1_START;
	case 18: return S5PC1XX_GPIO_J2_START;
	case 19: return S5PC1XX_GPIO_J3_START;
	case 20: return S5PC1XX_GPIO_J4_START;
	default:
		BUG();
	}
...
static int s5pc1xx_get_group(unsigned int irq)
{
	...
	switch (irq) {
	case S5PC1XX_GPIO_A0_START ... S5PC1XX_GPIO_A1_START - 1:
		return 0;
	case S5PC1XX_GPIO_A1_START ... S5PC1XX_GPIO_B_START - 1:
		return 1;
	case S5PC1XX_GPIO_B_START ... S5PC1XX_GPIO_C_START - 1:
		return 2;
	case S5PC1XX_GPIO_C_START ... S5PC1XX_GPIO_D_START - 1:
		return 3;
	case S5PC1XX_GPIO_D_START ... S5PC1XX_GPIO_E0_START - 1:
		return 4;
	case S5PC1XX_GPIO_E0_START ... S5PC1XX_GPIO_E1_START - 1:
		return 5;
	case S5PC1XX_GPIO_E1_START ... S5PC1XX_GPIO_F0_START - 1:
		return 6;
	case S5PC1XX_GPIO_F0_START ... S5PC1XX_GPIO_F1_START - 1:
		return 7;
	case S5PC1XX_GPIO_F1_START ... S5PC1XX_GPIO_F2_START - 1:
		return 8;
	case S5PC1XX_GPIO_F2_START ... S5PC1XX_GPIO_F3_START - 1:
		return 9;
	case S5PC1XX_GPIO_F3_START ... S5PC1XX_GPIO_G0_START - 1:
		return 10;
	case S5PC1XX_GPIO_G0_START ... S5PC1XX_GPIO_G1_START - 1:
		return 11;
	case S5PC1XX_GPIO_G1_START ... S5PC1XX_GPIO_G2_START - 1:
		return 12;
	case S5PC1XX_GPIO_G2_START ... S5PC1XX_GPIO_G3_START - 1:
		return 13;
	case S5PC1XX_GPIO_G3_START ... S5PC1XX_GPIO_H0_START - 1:
		return 14;
	case S5PC1XX_GPIO_I_START ... S5PC1XX_GPIO_J0_START - 1:
		return 15;
	case S5PC1XX_GPIO_J0_START ... S5PC1XX_GPIO_J1_START - 1:
		return 16;
	case S5PC1XX_GPIO_J1_START ... S5PC1XX_GPIO_J2_START - 1:
		return 17;
	case S5PC1XX_GPIO_J2_START ... S5PC1XX_GPIO_J3_START - 1:
		return 18;
	case S5PC1XX_GPIO_J3_START ... S5PC1XX_GPIO_J4_START - 1:
		return 19;
	case S5PC1XX_GPIO_J4_START ... S5PC1XX_GPIO_K0_START - 1:
		return 20;
	default:
		BUG();
	}
