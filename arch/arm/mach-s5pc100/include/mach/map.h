...
#define S5PC1XX_PA_TIMER	(0xE2500000)
#define S5PC1XX_PA_IIC0		(0xE1800000)
#define S5PC1XX_PA_IIC1		(0xE1A00000)
#define S5PC1XX_PA_GPIO		(0xE0200000)
#define S5PC1XX_PA_VIC0		(0xF2000000)
#define S5PC1XX_PA_VIC1		(0xF2100000)
#define S5PC1XX_PA_VIC2		(0xF2200000)
#define S5PC1XX_PA_VIC3		(0xF2300000)
#define S5PC1XX_PA_SROMC	(0xE8000000)
#define S5PC1XX_PA_LCD	   	(0xF8000000)
#define S5PC1XX_PA_SYSTIMER   	(0xE2600000)
#define S5PC1XX_PA_ADC		(0xE1700000)
#define S5PC1XX_PA_RTC		(0xE2800000)
#define S5PC1XX_PA_IIS	   	(0xE2100000)
#define S5PC1XX_PA_NAND         (0xB0E00000)
#define S5PC1XX_PA_USBHOST      (0xEC300000)
#define S5PC1XX_PA_OTG          (0xEC000000)
#define S5PC1XX_PA_OTGSFR       (0xEC100000)
#define S5PC1XX_PA_FIMC0	(0xFB200000)
#define S5PC1XX_PA_FIMC1	(0xFB300000)
#define S5PC1XX_PA_FIMC2	(0xFB400000)
#define S5PC1XX_PA_DMA   	(0xFA200000)
#define S5PC1XX_PA_HSMMC(x)     (0xEB000000 + ((x) * 0x100000))
#define S5PC1XX_PA_SPI0         (0xE1300000)
#define S5PC1XX_PA_SPI1         (0xE1400000)
#define S5PC1XX_PA_SPI2         (0xE1500000)
#define S5PC1XX_PA_KEYPAD	(0xE1600000)
#define S5PC1XX_PA_WDT          (0xE2700000)
#define S5PC1XX_PA_MFC		(0xF1700000)
#define S5PC1XX_PA_JPEG		(0xFB600000)
#define S5PC1XX_PA_AC97         (0xE2200000)
#define S5PC1XX_PA_G3D		(0xF3000000)
#define S5PC1XX_PA_ROTATOR	(0xFB100000)
#endif
