...
void s3c_fimc0_cfg_gpio(struct platform_device *dev)
{
	...
	s3c_gpio_cfgpin(S5PC11X_GPE1(4), S5PC11X_GPE1_4_CAM_A_RESET);
	s3c_gpio_cfgpin(S5PC11X_GPE1(5), S5PC11X_GPE1_5_CAM_A_FIELD);
	...
	s3c_gpio_cfgpin(S5PC11X_GPH2(0), S5PC11X_GPH2_0_CAM_B_DATA_0);
	s3c_gpio_cfgpin(S5PC11X_GPH2(1), S5PC11X_GPH2_1_CAM_B_DATA_1);
	s3c_gpio_cfgpin(S5PC11X_GPH2(2), S5PC11X_GPH2_2_CAM_B_DATA_2);
	s3c_gpio_cfgpin(S5PC11X_GPH2(3), S5PC11X_GPH2_3_CAM_B_DATA_3);
	s3c_gpio_cfgpin(S5PC11X_GPH2(4), S5PC11X_GPH2_4_CAM_B_DATA_4);
	s3c_gpio_cfgpin(S5PC11X_GPH2(5), S5PC11X_GPH2_5_CAM_B_DATA_5);
	s3c_gpio_cfgpin(S5PC11X_GPH2(6), S5PC11X_GPH2_6_CAM_B_DATA_6);
	s3c_gpio_cfgpin(S5PC11X_GPH2(7), S5PC11X_GPH2_7_CAM_B_DATA_7);
	s3c_gpio_cfgpin(S5PC11X_GPH3(0), S5PC11X_GPH3_0_CAM_B_PCLK);
	s3c_gpio_cfgpin(S5PC11X_GPH3(1), S5PC11X_GPH3_1_CAM_B_VSYNC);
	s3c_gpio_cfgpin(S5PC11X_GPH3(2), S5PC11X_GPH3_2_CAM_B_HREF);
	s3c_gpio_cfgpin(S5PC11X_GPH3(3), S5PC11X_GPH3_3_CAM_B_FIELD);
	s3c_gpio_cfgpin(S5PC11X_GPE1(3), S5PC11X_GPE1_3_CAM_A_CLKOUT);

	for (i = 0; i < 8; i++)
		s3c_gpio_setpull(S5PC11X_GPH2(i), S3C_GPIO_PULL_UP);

	for (i = 0; i < 4; i++)
		s3c_gpio_setpull(S5PC11X_GPH3(i), S3C_GPIO_PULL_UP);
}
