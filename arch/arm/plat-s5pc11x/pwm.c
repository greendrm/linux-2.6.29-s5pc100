...
struct s3c_pwm_pdata pwm_data[] = {
	{
		.gpio_no	= S5PC11X_GPD0(0),
		.gpio_name	= "GPD",
		.gpio_set_value	= S5PC11X_GPD_0_0_TOUT_0,
	}, {
		.gpio_no 	= S5PC11X_GPD0(1),
		.gpio_name	= "GPD",
		.gpio_set_value	= S5PC11X_GPD_0_1_TOUT_1,
	}, {
		.gpio_no 	= S5PC11X_GPD0(2),
		.gpio_name      = "GPD",
		.gpio_set_value = S5PC11X_GPD_0_2_TOUT_2,
	}, {
		.gpio_no 	= S5PC11X_GPD0(3),
		.gpio_name      = "GPD",
		.gpio_set_value = S5PC11X_GPD_0_3_TOUT_3,
	}, {
		.gpio_no 	= 0,
		.gpio_name	= NULL,
		.gpio_set_value = 0,
