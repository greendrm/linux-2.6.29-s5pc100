/* linux/arch/arm/plat-s5pc11x/include/plat/gpio-bank-c.h
 *
...
#define S5PC11X_GPC1_0_PCM_2_SCLK	(0x2 << 0)
#else
...
#if defined(CONFIG_CPU_S5PC110_EVT1)
#define S5PC11X_GPC1_1_PCM_2_EXTCLK	(0x2 << 4)
#else
...
#if defined(CONFIG_CPU_S5PC110_EVT1)
#define S5PC11X_GPC1_2_PCM_2_FSYNC	(0x2 << 8)
#else
...
#if defined(CONFIG_CPU_S5PC110_EVT1)
#define S5PC11X_GPC1_3_PCM_2_SIN	(0x2 << 12)
#else
...
#if defined(CONFIG_CPU_S5PC110_EVT1)
#define S5PC11X_GPC1_4_PCM_2_SOUT	(0x2 << 16)
#else
