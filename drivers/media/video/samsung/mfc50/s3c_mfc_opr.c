							   ...
							   buf_size)
{
	...
	mfc_debug
	    ("inst_no : %d, buf_addr : 0x%08x, start_byte_num : 0x%08x, buf_size : 0x%08x\n",
						      ...
						      int *consumed_strm_size)
{
	...
	dec_arg->out_display_Y_addr = (dec_arg->out_display_Y_addr << 11);
	dec_arg->out_display_C_addr = (dec_arg->out_display_C_addr << 11);
