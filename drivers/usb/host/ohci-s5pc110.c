/* ohci-s5pc110.c - Driver for USB HOST on Samsung S5PC110 processor
 *
 * Bus Glue for SAMSUNG S5PC110 USB HOST OHCI Controller
 *
 ...
 * Modified for SAMSUNG s5pc110 OHCI by Jingoo Han <jg1.han@samsung.com>
 *
