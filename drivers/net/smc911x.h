...
#elif defined(CONFIG_SH_MAGIC_PANEL_R2)||defined(CONFIG_MACH_SMDK6410)||defined(CONFIG_MACH_SMDKC100)||defined(CONFIG_MACH_SMDKC110)||defined(CONFIG_MACH_SMDK6442)
  #undef  SMC_USE_DMA		
  #define SMC_USE_16BIT		0
  #define SMC_USE_32BIT		1
