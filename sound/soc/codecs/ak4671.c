...
static const struct snd_soc_dapm_widget ak4671_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MIXER("LOUT2 Mixer", AK4671_LOUT2_POWER_MANAGERMENT, 0, 0,
			&ak4671_lout2_mixer_controls[0],
			ARRAY_SIZE(ak4671_lout2_mixer_controls)),
	SND_SOC_DAPM_MIXER("ROUT2 Mixer", AK4671_LOUT2_POWER_MANAGERMENT, 1, 0,
			&ak4671_rout2_mixer_controls[0],
	...
	/* Input MUXs */
	SND_SOC_DAPM_MUX("LIN MUX", SND_SOC_NOPM, 0, 0,
			&ak4671_lin_mux_control),
	SND_SOC_DAPM_MUX("RIN MUX", SND_SOC_NOPM, 0, 0,
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"LOUT2", "NULL", "LOUT2 Mixer"},
	{"ROUT2", "NULL", "ROUT2 Mixer"},
